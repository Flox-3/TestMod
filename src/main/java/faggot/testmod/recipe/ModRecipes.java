...
public class ModRecipes {
    public static final RecipeSerializer<GrowthChamberRecipe> GROWTH_CHAMBER_SERIALIZER = Registry.register(
            Registries.RECIPE_SERIALIZER, Identifier.of(TestMod.MOD_ID, "growth_chamber"),
    ...
    public static final RecipeType<GrowthChamberRecipe> GROWTH_CHAMBER_TYPE = Registry.register(
            Registries.RECIPE_TYPE, Identifier.of(TestMod.MOD_ID, "growth_chamber"), new RecipeType<GrowthChamberRecipe>() {
                @Override
    ...
    public static void registerRecipes() {
        TestMod.LOGGER.info("Registering Custom Recipes for " + TestMod.MOD_ID);
    }
}
